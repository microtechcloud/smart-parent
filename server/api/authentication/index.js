const {parseRegister,parseLogin,parseDevelopers,authenticateRequests,forgotPassword} = require("./lib");
module.exports = {
    login:{
        client:{
            get:(req,res,next)=>{
    ...
    authenticateRequests:{
        client:{
            get:(req,res,next)=>authenticateRequests.client(req,res,next)
        }
    },
    forgotPassword
